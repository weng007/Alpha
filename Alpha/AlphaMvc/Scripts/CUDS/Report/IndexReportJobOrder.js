    ...
    $.ajax(
    {
        ...
        success: function (data) {
            ...
            for (var i = 0; i < data.Table.length; i++) {
                ...
                html += '<a href="/Reports/FormReport/RptReportViewer.aspx?id=' + data.Table[i].ID + '" id="read' + data.Table[i].ID + '">' + '<img src="/Images/report.png" style="cursor:hand" class="Reportview"/></a>';
                html += '</td>';
                html += '</tr>';
            }
            html += '</tbody>';
