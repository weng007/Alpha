    ...
    $.ajax(
    {
        ...
        success: function (data) {
            ...
            for (var i = 0; i < data.Table.length; i++) {
                ...
                html += '<a href="/Requisition/EditRequisition?id=' + data.Table[i].ID + '&' + "Activity" + '" id="edit' + data.Table[i].ID + '" style="margin-right: 3px;">' + '<img src="/Images/edit.png" class="imgActivityUpdate"/></a>';
                html += '<a href="/Requisition/EditRequisition?id=' + data.Table[i].ID + '&' + "Activity" + '&' + "true" + '&' + data.Table[i].JobNo + '" id="read' + data.Table[i].ID + '">' + '<img src="/Images/view.png" class="imgActivityView"/></a>';
                html += '</td>';
                html += '</tr>';
            }
            html += '</tbody>';
