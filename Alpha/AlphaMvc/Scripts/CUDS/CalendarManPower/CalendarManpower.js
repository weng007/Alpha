    ...
    $.ajax(
    {
        ...
        success: function (data) {
            ...
            for (var i = 0; i < data.Table.length; i++) {
                ...
                html += '<a href="/JobOrder/EditJobOrder?id=' + data.Table[i].ID + '&' + "CarlendarMan" + '" id="edit' + data.Table[i].ID + '" style="margin-right: 3px;">' + '<img src="/Images/edit.png" class="imgManCalendarUpdate"/></a>';
                ...
                html += '<a href="/JobOrder/EditJobOrder?id=' + data.Table[i].ID + '&' + "CarlendarMan" + '&' + "true" + '" id="read' + data.Table[i].ID + '">' + '<img src="/Images/view.png" class="imgManCalendarView" /></a>';
                html += '</td>';
                html += '</tr>';
                //});
            }
